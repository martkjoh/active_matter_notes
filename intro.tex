...
\begin{figure}[!htb]
    ...
    \caption{To the left, two examples of microswimmers showing the so-called \textit{pusher} and \textit{puller} configurations.
    To the right, a schematic indicating how the breaststroke follows a nonreciprocal cycle in configuration space.
